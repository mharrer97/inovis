...
layout (location = 0) out vec4 out_motion_1;
layout (location = 1) out vec4 out_motion_2;
layout (location = 2) out vec4 out_motion_3;
layout (location = 3) out vec4 out_motion_4;
layout (location = 4) out vec4 out_motion_5;
layout (location = 5) out vec4 out_motion_6;
